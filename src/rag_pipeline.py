    ...
    def _initialize_pipeline(self):
        ...
        try:
            ...
            if not model_path.exists():
                logger.warning(
                    f"Model file not found at {model_path}. Using fallback pipeline."
                )
    ...
    def _create_dummy_pipeline(self):
        ...
        class DummyPipeline:
            def __call__(self, text, **kwargs):
                return [
                    {
                        "generated_text": "I'm sorry, but I'm currently unable to generate detailed responses. Please ensure you have the required model files installed."
                    }
                ]
        ...
        try:
            ...
            if product_filter and product_filter != "All Products":
                current_metadata = current_metadata[
                    current_metadata["product"] == product_filter
                ]
            ...
            if hasattr(self.generator.pipe, "stream"):
                ...
                try:
                    ...
                    logger.error(
                        f"Error generating response with fallback pipeline: {e}"
                    )
    ...
    def evaluate(self, questions: List[str]) -> pd.DataFrame:
        ...
        for question in questions:
            ...
            eval_result = self.evaluator.evaluate_response(
                question=question, answer=response, sources=result["sources"]
            )
